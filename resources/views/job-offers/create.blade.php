    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="card-enhanced p-8 hover-lift">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-bold text-gray-800 mb-2">Crear Nueva Oferta de Trabajo</h1>
                <p class="text-gray-600">Completa la información para publicar tu vacante</p>
            </div>
            ...
            <form action="{{ route('job-offers.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <div id="coordinates-info" class="mt-3 p-4 bg-blue-50 border border-blue-200 rounded-xl hidden">
                        <p class="text-sm text-blue-700 flex items-center">
                            <i class="fas fa-check-circle mr-2"></i>
                            <span>Coordenadas seleccionadas: <strong id="coords-display"></strong></span>
                    ...
                    <p class="mt-2 text-xs text-gray-500 flex items-center">
                        ...
                        Haz clic en el mapa para marcar la ubicación de la oferta laboral
                    </p>
...
function initMap() {
    ...
    // Verificar si hay coordenadas previas (old input para errores de validación)
    const oldGeolocation = "{{ old('geolocation', '') }}";
    if (oldGeolocation && oldGeolocation.trim() !== '') {
        try {
            const coords = oldGeolocation.split(',');
            ...
            console.log('Error parsing old coordinates');
        }
    }
    ...
    // Si hay coordenadas previas, agregar marcador
    if (oldGeolocation && oldGeolocation.trim() !== '') {
...
function addMarker(lat, lng) {
    ...
    const popupContent = `
        <div class="p-2">
            <h3 class="font-semibold text-gray-800">Ubicación seleccionada</h3>
