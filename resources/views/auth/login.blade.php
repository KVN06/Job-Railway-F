    ...
    <header class="relative z-10 border-b border-white/10 bg-neutral-950/70 backdrop-blur">
        <div class="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-5 fade-in-up">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('login') }}" class="hidden items-center gap-2 rounded-full btn-primary px-4 py-2 text-sm font-semibold text-white shadow-lg transition md:inline-flex">
   ...
   class="group flex items-center justify-center gap-3 rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm font-semibold text-neutral-700 shadow-sm transition hover:-translate-y-0.5 hover:border-neutral-300 hover:bg-neutral-50">
    ...
    Iniciar sesión con Google
                    ...
                    <p class="mt-6 text-center text-sm text-neutral-600">¿No tienes una cuenta?
                        <a href="{{ route('register') }}" class="font-semibold text-blue-900 transition hover:text-blue-700">Regístrate</a>
                    </p>
                </div>
            </div>

            <p class="mx-auto max-w-3xl text-center text-xs text-neutral-200/80 fade-in-up" style="--fade-delay: 0.35s;">Al continuar aceptas nuestros <a href="#" class="font-semibold text-blue-200 hover:text-blue-100">Términos de servicio</a> y <a href="#" class="font-semibold text-blue-200 hover:text-blue-100">Aviso de privacidad</a>.</p>
        </section>
    </main>
